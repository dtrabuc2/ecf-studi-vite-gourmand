-- Données catalogue Vite & Gourmand
-- À exécuter après la création du schéma viteetgourmand.sql.
USE viteetgourmand;

INSERT INTO menus (id, title, description, theme, dietary_regime, min_people, base_price, conditions, available_stock)
VALUES
(1, 'Menu Prestige', 'Une formule gastronomique pensée pour les mariages, réceptions élégantes et événements professionnels.', 'Prestige', 'classic', 10, 49.50, 'Réservation conseillée au moins 7 jours à l’avance. Service sur place selon disponibilité.', 20),
(2, 'Menu Végétarien Délice', 'Une formule généreuse à base de légumes de saison, céréales et desserts gourmands.', 'Saisonnier', 'vegetarian', 8, 35.00, 'Commande conseillée 5 jours avant la prestation. Options sans lactose sur demande.', 20),
(3, 'Menu Cocktail Chic', 'Une formule conçue pour les cocktails dînatoires, lancements et événements professionnels.', 'Cocktail', 'classic', 15, 42.00, 'Commande recommandée 10 jours avant la prestation. Service et vaisselle premium selon disponibilité.', 20),
(4, 'Menu Enfant Gourmand', 'Une formule familiale pensée pour les anniversaires, baptêmes et réceptions avec enfants.', 'Famille', 'classic', 5, 18.00, 'Réservation conseillée 3 jours avant. Couverts et serviettes inclus.', 30),
(5, 'Menu Méditerranéen Végétal', 'Une formule végétalienne aux accents méditerranéens, fraîche et colorée.', 'Méditerranéen', 'vegan', 6, 34.00, 'Commande conseillée 4 jours avant. Préparation 100 % végétale.', 15)
...
(11, 'Saint-Jacques snackées et beurre d’agrumes', 'Noix de Saint-Jacques juste snackées, sauce légère aux agrumes.'),
(12, 'Filet de bœuf sauce truffée', 'Filet de bœuf rôti, sauce à la truffe et jus réduit.'),
(13, 'Homard grillé et légumes de saison', 'Homard grillé accompagné de légumes frais.'),
(14, 'Sphère chocolat grand cru', 'Dessert individuel au chocolat noir et cœur gourmand.'),
...
(17, 'Gaspacho de tomates anciennes', 'Gaspacho frais de tomates anciennes et herbes fraîches.'),
(18, 'Tartare avocat mangue et herbes fraîches', 'Avocat, mangue, citron vert et herbes aromatiques.'),
(19, 'Risotto crémeux aux cèpes et parmesan', 'Risotto aux cèpes, parmesan et persil.'),
...
(25, 'Brochettes yakitori de poulet', 'Brochettes de poulet marinées et légèrement caramélisées.'),
...
(30, 'Velouté doux de potimarron', 'Velouté crémeux de potimarron.'),
...
(34, 'Filet de poisson pané et purée', 'Poisson pané croustillant et purée de pommes de terre.'),
...
(38, 'Falafels aux herbes et sauce tahini', 'Falafels maison, herbes fraîches et sauce tahini.'),
(39, 'Tofu grillé au gingembre', 'Tofu mariné puis grillé, gingembre, soja et citron vert.'),
...
(42, 'Tartelette citron meringuée', 'Tartelette au citron et meringue légère.'),
...
ON DUPLICATE KEY UPDATE category = VALUES(category), position = VALUES(position);
...
(32,1),(32,3),(33,1),(33,2),(34,1),(34,3),(38,7),(39,6),(42,1),(42,2),(42,3)
ON DUPLICATE KEY UPDATE allergen_id = VALUES(allergen_id);

UPDATE menus SET available_stock = CASE id
    WHEN 1 THEN 20
    WHEN 2 THEN 20
    WHEN 3 THEN 20
    WHEN 4 THEN 30
